...
export async function generateMetadata() {
  return generateMeta({
    ...
    description:
      "Use this Hypelive Dashboard and Tailwind CSS product page template to create great looking pages for each product, with detailed descriptions, images, pricing, and customer reviews.",
